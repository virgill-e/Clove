         ...
         >
           <div class="glass-panel bg-white/30 p-8 md:p-14 rounded-[3rem] shadow-2xl w-full max-w-md mx-6 border-[1.5px] border-white/40 cursor-auto" @click.stop>
             ...
             <form class="space-y-4 font-sans" @submit.prevent>
               ...
               <button class="form-item w-full bg-espresso text-matcha font-bold tracking-widest uppercase rounded-3xl py-4 mt-6 hover:bg-espresso/90 transition-all hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 active:scale-95 flex items-center justify-center gap-2">
                 Sign In
         ...
         >
           <div class="glass-panel bg-black/25 p-8 md:p-14 rounded-[3rem] shadow-2xl w-full max-w-md mx-6 border-[1.5px] border-white/20 cursor-auto" @click.stop>
             ...
             <form class="space-y-4 font-sans" @submit.prevent>
               ...
               <button class="form-item w-full bg-matcha text-espresso font-bold tracking-widest uppercase rounded-3xl py-4 mt-6 hover:bg-matcha/90 transition-all hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 active:scale-95 flex items-center justify-center gap-2">
                 Create Account
